...
class Extension implements \Serializable {
   ...
   *
   * @todo Remove public access and replace with getType() method.
   *
   * @var string
   */
  public $type;
   ...
   *
   * @todo Remove this property and stop assuming/requiring .module/.profile
   *   files to exist.
  ...
  public function unserialize($data) {
    ...
    // @todo Stop assuming/requiring .module/.profile files to exist.
    // @see https://drupal.org/node/340723
