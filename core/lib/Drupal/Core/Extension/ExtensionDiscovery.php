...
class ExtensionDiscovery {
   ...
   *
   * @todo Duplicates ORIGIN_ROOT, remove this origin.
   */
  ...
  protected function scanDirectory($dir, $include_tests) {
    ...
    foreach ($iterator as $key => $fileinfo) {
      ...
      // @todo Require 'type' property to be defined first (or lead by example).
      $type = FALSE;
      ...
      // @todo Do not require .module/.profile files.
