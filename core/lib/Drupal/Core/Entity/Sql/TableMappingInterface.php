...
/**
 * Provides a common interface for table mapping implementations.
 */
interface TableMappingInterface {
  ...
  /**
   * Returns a list of entity field names for the given table.
   *
   * @param string $table_name
  ...
  /**
   * Returns a list of database columns which store denormalized data.
   *
