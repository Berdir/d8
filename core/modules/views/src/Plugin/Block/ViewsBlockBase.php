...
abstract class ViewsBlockBase extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *   The current user.
   */
  public function __construct($configuration, $plugin_id, $plugin_definition, ViewExecutableFactory $executable_factory, EntityStorageInterface $storage, AccountInterface $user) {
