...
class ViewsHandlerManager extends DefaultPluginManager {
   ...
   */
  public function __construct($handler_type, \Traversable $namespaces, ViewsData $views_data, CacheBackendInterface $cache_backend, LanguageManagerInterface $language_manager) {
    parent::__construct("Plugin/views/$handler_type", $namespaces, 'Drupal\Component\Annotation\PluginID');
