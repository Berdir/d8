...
class BlockLanguageTest extends WebTestBase {
    ...
    $edit = array(
      'visibility' => array(
        'language' => array(
          ...
          'context_mapping' => ['language' => '@language.current_language_context:language.language_interface'],
        ),
      ),
    );
  ...
  public function testMultipleLanguageTypes() {
    ...
    $edit = [
      'visibility[language][context_mapping][language]' => '@language.current_language_context:language.language_interface',
    ...
    $edit = [
      'visibility[language][context_mapping][language]' => '@language.current_language_context:language.language_content'
    ];
