...
class AggregatorFeedBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *   The entity query object for feed items.
   */
  public function __construct($configuration, $plugin_id, $plugin_definition, FeedStorageInterface $feed_storage, ItemStorageInterface $item_storage, QueryInterface $item_query) {
