...
class ConfigTestController extends ControllerBase {
  ...
  function enable(ConfigTest $config_test) {
    ...
    return new RedirectResponse($this->url('entity.config_test.list', array(), array('absolute' => TRUE)));
  }
  ...
  function disable(ConfigTest $config_test) {
    ...
    return new RedirectResponse(\Drupal::url('entity.config_test.list', array(), array('absolute' => TRUE)));
  }
