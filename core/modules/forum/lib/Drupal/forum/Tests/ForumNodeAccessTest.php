...
class ForumNodeAccessTest extends WebTestBase {
  ...
  function testForumNodeAccess() {
    ...
    $this->assertText($private_node->label(), 'Private node found in block by $access_user');
    $this->assertText($public_node->label(), 'Public node found in block by $access_user');
    ...
    $this->assertNoText($private_node->label(), 'Private node not found in block by $no_access_user');
    $this->assertText($public_node->label(), 'Public node found in block by $no_access_user');
  }
