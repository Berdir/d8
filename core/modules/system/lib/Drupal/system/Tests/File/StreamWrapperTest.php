...
class StreamWrapperTest extends WebTestBase {
  ...
  function testUriFunctions() {
    ...
    $this->assertEqual(file_stream_wrapper_get_instance_by_scheme('public')->getDirectoryPath(), $config->get('path.public'), 'Expected default directory path was returned.');
