...
class FieldSqlStorageTest extends EntityUnitTestBase {
  ...
  function setUp() {
    ...
    $this->table = FieldableDatabaseEntityStorage::_fieldTableName($this->field);
    $this->revision_table = FieldableDatabaseEntityStorage::_fieldRevisionTableName($this->field);
  }
  ...
  function testFieldLoad() {
    ...
    $columns = array('bundle', 'deleted', 'entity_id', 'revision_id', 'delta', 'langcode', FieldableDatabaseEntityStorage::_fieldColumnName($this->field, 'value'));
  ...
  function testFieldUpdateFailure() {
    ...
    foreach (FieldableDatabaseEntityStorage::_fieldSqlSchema($prior_field) as $table_name => $table_info) {
  ...
  function testFieldUpdateIndexesWithData() {
    ...
    $instance->save();
    $tables = array(FieldableDatabaseEntityStorage::_fieldTableName($field), FieldableDatabaseEntityStorage::_fieldRevisionTableName($field));
  ...
  function testFieldSqlStorageForeignKeys() {
    ...
    $schemas = FieldableDatabaseEntityStorage::_fieldSqlSchema($field);
    $schema = $schemas[FieldableDatabaseEntityStorage::_fieldTableName($field)];
    $this->assertEqual(count($schema['foreign keys']), 1, 'There is 1 foreign key in the schema');
    $foreign_key = reset($schema['foreign keys']);
    $foreign_key_column = FieldableDatabaseEntityStorage::_fieldColumnName($field, $foreign_key_name);
  ...
  public function testTableNames() {
    ...
    $this->assertEqual(FieldableDatabaseEntityStorage::_fieldTableName($field), $expected);
    $expected = 'short_entity_type_revision__short_field_name';
    $this->assertEqual(FieldableDatabaseEntityStorage::_fieldRevisionTableName($field), $expected);
    ...
    $this->assertNotEqual(FieldableDatabaseEntityStorage::_fieldTableName($field), FieldableDatabaseEntityStorage::_fieldTableName($field2));
    $this->assertNotEqual(FieldableDatabaseEntityStorage::_fieldRevisionTableName($field), FieldableDatabaseEntityStorage::_fieldRevisionTableName($field2));
