...
class SchemaTest extends WebTestBase {
  ...
  function testSchema() {
    ...
    $index_exists = drupal_container()->get('database')->getConnection()->schema()->indexExists('test_table', 'test_field');
    ...
    $index_exists = drupal_container()->get('database')->getConnection()->schema()->indexExists('test_table2', 'test_field');
  ...
  function checkSchemaComment($description, $table, $column = NULL) {
    if (method_exists(drupal_container()->get('database')->getConnection()->schema(), 'getComment')) {
      $comment = drupal_container()->get('database')->getConnection()->schema()->getComment($table, $column);
