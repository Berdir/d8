...
/**
 * Provides custom field definitions for a specific bundle within an entity type.
 *
 * @param \Drupal\Core\Entity\EntityTypeInterface $entity_type
 *   The entity type definition.
 * @param string $bundle
 ...
 *   The list of field definitions for the bundle.
 *
 * @return \Drupal\Core\Field\FieldDefinitionInterface[]
 *   An array of field definitions, keyed by field name.
 *
 ...
 * @see \Drupal\Core\Entity\EntityManagerInterface::getFieldDefinitions()
 */
function hook_entity_field_info_by_bundle(\Drupal\Core\Entity\EntityTypeInterface $entity_type, $bundle, array $base_field_definitions) {
 ...
 *
 * @param \Drupal\Core\Field\FieldDefinitionInterface[] $fields
 *   The array of field definitions for the entity type and bundle.
 * @param \Drupal\Core\Entity\EntityTypeInterface $entity_type
 *   The entity type definition.
 * @param string $bundle
 *   The bundle.
 ...
 * @see hook_entity_field_info_by_bundle()
 */
function hook_entity_field_info_by_bundle_alter(&$fields, \Drupal\Core\Entity\EntityTypeInterface $entity_type, $bundle) {
