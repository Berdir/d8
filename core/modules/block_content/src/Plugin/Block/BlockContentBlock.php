...
class BlockContentBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct($configuration, $plugin_id, $plugin_definition, BlockManagerInterface $block_manager, EntityManagerInterface $entity_manager, ModuleHandlerInterface $module_handler, AccountInterface $account) {
