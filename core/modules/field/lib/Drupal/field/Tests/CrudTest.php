...
class CrudTest extends FieldUnitTestBase {
  ...
  function testCreateField() {
    ...
    field_test_memorize();
    $create_field = field_create_field($field_definition);
    ...
    $this->assertEqual($field['settings'], $field_type['settings'], 'Default field settings have been written.');

    // Ensure that default storage was set.
    $this->assertEqual($field['storage']['type'], variable_get('field_storage_default'), 'The field type is properly saved.');
