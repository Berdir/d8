...
use Drupal\system\Tests\Entity\EntityUnitBaseTest;

/**
 * Parent class for Field API unit tests.
 */
abstract class FieldUnitTestBase extends EntityUnitBaseTest {
   ...
   * @var array
   */
  public static $modules = array('field_test', 'entity');
