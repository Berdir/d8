...
class FieldInstanceConfig extends ConfigEntityBase implements FieldInstanceConfigInterface {
  ...
  public function __construct(array $values, $entity_type = 'field_instance_config') {
    ...
    if (empty($values['field_name'])) {
      throw new FieldException(format_string('Attempt to create an instance of a field without a field_name.'));
    }
    if (empty($values['entity_type'])) {
      throw new FieldException(format_string('Attempt to create an instance of field @field_name without an entity_type.', array('@field_name' => $values['field_name'])));
    }
