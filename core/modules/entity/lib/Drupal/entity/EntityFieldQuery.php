...
class EntityFieldQuery {
   ...
   *   results were found. The inner array values cosist of a numerical array
   *   with the id, vid and bundle. To traverse the returned array:
   *   @code
  ...
  function finishQuery($select_query, $id_key = 'entity_id') {
    ...
    foreach ($select_query->execute() as $partial_entity) {
      ...
      $entity = array($partial_entity->entity_id, $partial_entity->revision_id, $bundle);
