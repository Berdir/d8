...
class EntityApiTest extends WebTestBase {
  ...
  function testCRUD() {
    ...
    $entities = array_values(entity_load_by_properties('entity_test', array('name' => 'test')));
    ...
    $entities = array_values(entity_load_by_properties('entity_test', array('name' => 'test2')));
    $entities[0]->delete();
    $entities = array_values(entity_load_by_properties('entity_test', array('name' => 'test2')));
