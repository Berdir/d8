...
class TaxonomyController extends ControllerBase {
  ...
  public function addForm(VocabularyInterface $taxonomy_vocabulary) {
    $term = $this->entityManager()->getStorageController('taxonomy.term')->create(array('vid' => $taxonomy_vocabulary->id()));
    if ($this->moduleHandler()->moduleExists('language')) {
      $term->langcode = language_get_default_langcode('taxonomy.term', $taxonomy_vocabulary->id());
    }
