...
class TermSelection extends SelectionBase {
  ...
  public function getReferenceableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    ...
    $bundle_names = !empty($this->fieldDefinition->getSetting('handler_settings')['target_bundles']) ? $this->fieldDefinition->getSetting('handler_settings')['target_bundles'] : array_keys($bundles);
