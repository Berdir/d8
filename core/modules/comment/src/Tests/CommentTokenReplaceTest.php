...
class CommentTokenReplaceTest extends CommentTestBase {
  ...
  function testCommentTokenReplacement() {
    ...
    $base_cacheable_metadata = CacheableMetadata::createFromObject($comment);
    $metadata_tests = [];
    $metadata_tests['[comment:cid]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:hostname]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:author]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:mail]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:homepage]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:title]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:body]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:langcode]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:url]'] = $base_cacheable_metadata;
    $metadata_tests['[comment:edit-url]'] = $base_cacheable_metadata;
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:created]'] = $cacheable_metadata->addCacheTags(['rendered']);
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:created:since]'] = $cacheable_metadata->setCacheMaxAge(0);
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:changed:since]'] = $cacheable_metadata->setCacheMaxAge(0);
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:parent:cid]'] = $cacheable_metadata->addCacheTags(['comment:1']);
    $metadata_tests['[comment:parent:title]'] = $cacheable_metadata;
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:entity]'] = $cacheable_metadata->addCacheTags(['node:2']);
    // Test node specific tokens.
    $metadata_tests['[comment:entity:nid]'] = $cacheable_metadata;
    $metadata_tests['[comment:entity:title]'] = $cacheable_metadata;
    $cacheable_metadata = clone $base_cacheable_metadata;
    $metadata_tests['[comment:author:uid]'] = $cacheable_metadata->addCacheTags(['user:2']);
    $metadata_tests['[comment:author:name]'] = $cacheable_metadata;
    ...
    foreach ($tests as $input => $expected) {
      ...
      $output = $token_service->replace($input, array('comment' => $comment), array('langcode' => $language_interface->getId()), $cacheable_metadata);
