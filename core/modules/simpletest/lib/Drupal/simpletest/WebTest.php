...
abstract class WebTest extends Test {
   ...
   *
   * Drupal\simpletest\WebTest itself never sets this but always obeys what is
   * set.
   */
  ...
  /**
   * Constructor for Drupal\simpletest\WebTest.
   */
   ...
   *
   * This method is called by Drupal\simpletest\WebTest::setUp(), and preloads
   ...
   *
   * This method is called by Drupal\simpletest\WebTest::setUp() after enabling
  ...
  protected function curlHeaderCallback($curlHandler, $header) {
    ...
    // by Drupal\simpletest\WebTest::error().
    if (preg_match('/^X-Drupal-Assertion-[0-9]+: (.*)$/', $header, $matches)) {
      // Call Drupal\simpletest\WebTest::error() with the parameters from the header.
