 ...
 */
class NumberItemTest extends DrupalUnitTestBase {
   ...
   * @var array
   */
  public static $modules = array('number', 'entity_test');
  ...
  public function setUp() {
    parent::setUp();
    $this->enableModules(array('system', 'entity', 'field', 'text', 'options', 'field_sql_storage', 'entity_test', 'number'));
