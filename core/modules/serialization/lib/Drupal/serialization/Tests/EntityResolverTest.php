...
class EntityResolverTest extends NormalizerTestBase {
  ...
  function testUuidEntityResolver() {
    ...
    $entity->set('entity_ref', array(array('target_id' => 1)));
    $entity->save();

    $field_uri = url('rest/relation/entity_test_mulrev/entity_test_mulrev/entity_ref', array('absolute' => TRUE));
    ...
    $field_value = $denormalized->get('entity_ref')->getValue();
