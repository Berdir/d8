...
class AdminNegotiator implements ThemeNegotiatorInterface {
  ...
  public function applies(RouteMatchInterface $route_match) {
    return $this->adminContext->isAdminRoute($route_match->getRouteObject()) && $this->entityManager->hasController('user_role', 'storage') && $this->user->hasPermission('view the administration theme');
  }
