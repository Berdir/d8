...
class UserLocalTasksTest extends LocalTaskIntegrationTest {
  ...
  public function getUserAdminRoutes() {
    return array(
      array('entity.user.list', array(array('entity.user.list', 'user.admin_permissions', 'entity.user_role.list'))),
      array('user.admin_permissions', array(array('entity.user.list', 'user.admin_permissions', 'entity.user_role.list'))),
      array('entity.user_role.list', array(array('entity.user.list', 'user.admin_permissions', 'entity.user_role.list'))),
