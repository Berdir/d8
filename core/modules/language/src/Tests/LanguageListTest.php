...
class LanguageListTest extends WebTestBase {
  ...
  function testLanguageList() {
    ...
    $this->assertUrl(\Drupal::url('entity.configurable_language.list', [], ['absolute' => TRUE]));
    ...
    $this->assertUrl(\Drupal::url('entity.configurable_language.list', [], ['absolute' => TRUE, 'language' => $language]));
    ...
    $this->assertUrl(\Drupal::url('entity.configurable_language.list', [], ['absolute' => TRUE, 'language' => $english]));
