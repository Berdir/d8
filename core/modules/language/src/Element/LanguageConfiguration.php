...
class LanguageConfiguration extends FormElement {
  ...
  public static function processLanguageConfiguration(&$element, FormStateInterface $form_state, &$form) {
    ...
    $element['langcode'] = array(
      ...
      '#description' => t('Explanation of the language options is found on the <a href="@languages_list_page">languages list page</a>.', array('@languages_list_page' => \Drupal::url('entity.configurable_language.list'))),
