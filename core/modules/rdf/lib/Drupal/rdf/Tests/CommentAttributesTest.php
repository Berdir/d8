...
class CommentAttributesTest extends CommentTestBase {
  ...
  function _testBasicCommentRdfaMarkup($comment, $account = array()) {
    ...
    $this->assertEqual((string)$comment_title[0]->a, $comment->subject->value, t("RDFa markup for the comment title found."));
    ...
    $this->assertEqual((string)$comment_body[0]->p, $comment->comment->value, t("RDFa markup for the comment body found."));
  }
}
