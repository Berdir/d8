...
class LocaleUpdateInterfaceTest extends LocaleUpdateBase {
  ...
  public function testInterface() {
    ...
    $this->assertRaw(t('No translatable languages available. <a href="@add_language">Add a language</a> first.', array('@add_language' => \Drupal::url('entity.configurable_language.list'))), 'Language message');
